...
const artists = [
  { name:'РГД', tag:'01 / ДОН', copy:'Ритм земли. Голос поколения.', image:'/images/artist-rgd-cutout-v5.png', position:'center bottom' },
  { name:'BELOBOKA', tag:'02 / НОВЫЙ ФОЛК', copy:'Фольклор, индустриальный звук и новая сцена.', image:'/images/artist-beloboka-cutout-v6.png', position:'center bottom' },
  { name:'YAZHEVIKA', tag:'03 / ГОЛОС', copy:'Сталь, крест и женская сила Дона.', image:'/images/artist-yazhevika-cutout-v9.png', position:'center bottom' },
];
const playlist = [
...
const musicFaces = [
  ...
  {src:'/images/artist-beloboka-cutout-v6.png',name:'BELOBOKA',era:'СЕЙЧАС',kind:'modern'},
  {src:'/images/artist-yazhevika-cutout-v9.png',name:'YAZHEVIKA',era:'СЕЙЧАС',kind:'modern'},
];
...
export default function Home() {
  ...
  return <main>
    ...
    <style>{`@media(min-width:901px){.hero,.history-scene,.people-scene,.nation-scene,.world-scene,.genealogy-scene,.generations-scene,.hosts-collage-scene,.join-scene{height:100svh!important;min-height:680px!important;max-height:1080px!important;overflow:hidden!important}.genealogy-object{top:8%!important;height:88%!important;width:min(72vw,1120px)!important}.living-culture{height:auto!important;min-height:0!important;padding:9vh 6vw 0!important;overflow:hidden!important}.artist-stage{height:min(70vh,760px)!important;min-height:600px!important;max-height:760px!important;margin-top:3vh!important}.battle-chronicle{height:100svh!important;min-height:680px!important;max-height:1080px!important;margin-top:0!important}.war-memory{height:100svh!important;min-height:680px!important;max-height:1080px!important}.war-archive{top:8%!important;height:86%!important}.join-scene .join-copy{inset:12vh 6vw auto!important}.join-scene .join-copy h2{margin:3vh 0!important;font-size:clamp(52px,6.7vw,108px)!important}.music-scene{height:clamp(680px,56.25vw,980px)!important;min-height:680px!important;max-height:980px!important}}@media(max-width:900px){.hero,.history-scene,.people-scene,.nation-scene,.world-scene,.genealogy-scene,.generations-scene,.hosts-collage-scene,.join-scene{height:100svh!important;min-height:680px!important;max-height:980px!important;overflow:hidden!important}.scene h2,.nation-title,.roots-copy h2,.culture-copy h2,.join-copy h2{font-size:clamp(38px,11vw,72px)!important;line-height:.88!important}.scene-copy p,.nation-copy p,.roots-copy p,.culture-copy p,.join-copy p{font-size:clamp(14px,3.6vw,18px)!important;line-height:1.4!important}.nation-copy .nation-title{white-space:nowrap!important;text-wrap:nowrap!important;font-size:clamp(37px,9.7vw,66px)!important}.generations-scene .culture-copy h2,.generations-scene .culture-copy h2 i{white-space:normal!important;text-wrap:balance!important}.genealogy-object{top:19%!important;height:78%!important}.hosts-collage-scene{padding-top:78px!important;grid-template-rows:auto 1fr!important}.hosts-collage-stage{height:auto!important;min-height:0!important}.living-culture{height:auto!important;min-height:0!important;padding:82px 14px 0!important;overflow:hidden!important}.artist-stage{height:calc(100svh - 92px)!important;min-height:620px!important;max-height:900px!important;margin-top:24px!important}.battle-chronicle{height:100svh!important;min-height:680px!important;max-height:980px!important;margin-top:0!important}.music-scene{height:100svh!important;min-height:680px!important;max-height:980px!important}.music-wide-bg{object-fit:cover!important}.music-scene .music-copy{top:88px!important}.war-memory{height:100svh!important;min-height:760px!important;max-height:980px!important}.war-copy{top:86px!important;width:90vw!important}.war-archive{top:46%!important;height:49%!important}.join-scene .join-copy{inset:88px 5vw auto!important}.join-scene .join-copy h2{margin:20px 0!important}}@media(max-width:520px){.hero,.history-scene,.people-scene,.nation-scene,.world-scene,.genealogy-scene,.generations-scene,.hosts-collage-scene,.join-scene{min-height:720px!important;max-height:none!important}.nation-copy .nation-title{font-size:clamp(32px,9.2vw,48px)!important}.world-list{display:none!important}.artist-stage-copy h3{overflow-wrap:normal!important;word-break:normal!important;hyphens:none!important}.music-scene .music-copy h2 span{white-space:normal!important;text-wrap:balance!important}.war-copy h2{font-size:clamp(38px,10.6vw,58px)!important}}`}</style>
    <style>{`/* One visual chapter equals one viewport. */
    .hero,.history-scene,.people-scene,.nation-scene,.world-scene,.genealogy-scene,.generations-scene,.hosts-collage-scene,.music-scene,.war-memory,.join-scene,.artist-stage,.battle-chronicle{height:100svh!important;min-height:680px!important;max-height:none!important;overflow:hidden!important}
    .genealogy-scene{background:#080706!important}
    .genealogy-object{inset:0!important;width:100%!important;height:100%!important;transform-origin:76% 46%!important}
    .genealogy-tree{width:100%!important;height:100%!important;object-fit:cover!important;object-position:center!important;filter:contrast(1.08) brightness(.78)!important}
    .genealogy-shade{background:linear-gradient(90deg,#060707fa 0%,#060707e8 27%,#06070782 43%,transparent 68%),linear-gradient(0deg,#0506069c,transparent 48%)!important}
    .genealogy-scene .roots-copy{left:6vw!important;top:14vh!important;width:min(620px,40vw)!important;max-width:none!important}
    .living-culture{position:relative!important;height:auto!important;min-height:0!important;padding:0!important;overflow:hidden!important}
    .living-heading{position:absolute!important;z-index:150!important;left:6vw!important;top:12vh!important;width:min(720px,86vw)!important;margin:0!important;pointer-events:none}
    .living-heading h2{margin:3vh 0 2vh!important;font-size:clamp(52px,7vw,112px)!important;line-height:.86!important}
    .artist-stage{width:100vw!important;margin:0 calc(50% - 50vw)!important;border:0!important;border-radius:0!important}
    .artist-stage-bg{inset:-5%!important;width:110%!important;height:110%!important;object-fit:cover!important}
    .artist-stage-person{z-index:4!important}
    .artist-stage-copy{z-index:160!important;left:6vw!important;bottom:15vh!important;width:min(620px,48vw)!important;max-width:none!important;padding:0!important;background:none!important;backdrop-filter:none!important;border:0!important;box-shadow:none!important}
    .artist-tabs{z-index:170!important}
    .battle-chronicle{width:100vw!important;margin:0 calc(50% - 50vw)!important}
    .music-wide-bg{object-fit:cover!important}
    .join-scene .join-copy{left:6vw!important;right:auto!important;width:88vw!important;max-width:88vw!important}
    @media(max-width:900px){
      .hero,.history-scene,.people-scene,.nation-scene,.world-scene,.genealogy-scene,.generations-scene,.hosts-collage-scene,.music-scene,.war-memory,.join-scene,.artist-stage,.battle-chronicle{height:100svh!important;min-height:720px!important;max-height:none!important}
      .living-heading{left:20px!important;right:20px!important;top:88px!important;width:auto!important}
      .genealogy-object{inset:0!important;width:100%!important;height:100%!important}
      .genealogy-tree{object-position:64% center!important}
      .genealogy-scene .roots-copy{left:20px!important;top:88px!important;width:88vw!important}
      .living-heading h2{font-size:clamp(40px,12vw,68px)!important}
      .artist-stage-copy{left:18px!important;right:18px!important;bottom:132px!important;width:auto!important;max-width:none!important}
      .artist-stage-copy h3{font-size:clamp(40px,12vw,70px)!important;word-break:normal!important;overflow-wrap:normal!important}
      .join-scene .join-copy{left:5vw!important;right:auto!important;width:90vw!important;max-width:90vw!important}
      .join-scene .join-copy h2{font-size:clamp(36px,9.5vw,66px)!important;line-height:.88!important}
    }`}</style>
    ...
    <nav className="act-strip" aria-label="Главы"><span>ГЛАВЫ</span>{acts.slice(0,5).map(([n,t,id])=><button key={id} onClick={()=>jump(id)}><b>{n}</b>{t}</button>)}</nav>
    ...
    <section id="artists" className="scene living-culture">
      ...
      <div className={`artist-stage artist-stage-${artist}`} onMouseMove={e=>{const r=e.currentTarget.getBoundingClientRect();setPointer({x:(e.clientX-r.left)/r.width-.5,y:(e.clientY-r.top)/r.height-.5})}} onMouseLeave={()=>setPointer({x:0,y:0})}>
        ...
        <img className={`artist-stage-person active artist-person-${artist}`} src={artists[artist].image} alt={artists[artist].name} decoding="async" style={{objectPosition:artists[artist].position,transform:`translate3d(${pointer.x*12}px,${pointer.y*8}px,0) scale(1.01)`}}/>
    ...
    <section id="music" className="scene music-scene">
      <div className="music-wall"><img className="music-wide-bg" src="/images/music-generations-bg-v1.png" alt="Казачья песня объединяет поколения у донской церкви"/><div className="music-wall-shade"/><div className="music-era-rail"><b>1887</b><i/><em>ГОЛОС ПЕРЕДАЁТСЯ</em><i/><b>СЕЙЧАС</b></div></div>
      <div className="music-copy"><p className="chapter">ГОЛОСА СКВОЗЬ ВРЕМЯ</p><h2><span>ПЕСНЯ</span><span><i>НЕ ПРЕРЫВАЛАСЬ.</i></span><span>ОНА ЖИВЁТ.</span></h2><p className="music-lead">От старших к молодым, от семейной памяти к новой сцене - одна живая песенная традиция.</p><div className="music-count"><strong>∞</strong><span>ПЕСЕН<br/>ОДНОГО НАРОДА</span></div></div>
    ...
    <section id="today" className="scene today-scene war-memory" onMouseMove={event=>{const r=event.currentTarget.getBoundingClientRect();setWarPointer({x:(event.clientX-r.left)/r.width-.5,y:(event.clientY-r.top)/r.height-.5})}} onMouseLeave={()=>setWarPointer({x:0,y:0})}>
      ...
      <div className="war-archive">
        <figure className="war-photo w1" style={{transform:`translate3d(${warPointer.x*24}px,${warPointer.y*16}px,0) rotate(-3deg)`}}><img src="/images/archive-curated-v1/new/war-group.jpg" alt="Группа казаков начала XX века"/><figcaption><b>ПЕРЕД СЛУЖБОЙ</b><span>Фотография сохраняла лица тех, кто уходил.</span></figcaption></figure>
        <figure className="war-photo w2" style={{transform:`translate3d(${warPointer.x*-19}px,${warPointer.y*-12}px,0) rotate(2deg)`}}><img src="/images/archive-curated-v1/new/war-regiment-1892.jpg" alt="Казаки Российской армии, 1892 год"/><figcaption><b>ПОЛК</b><span>За строем и формой всегда оставался человек.</span></figcaption></figure>
        <figure className="war-photo w3" style={{transform:`translate3d(${warPointer.x*13}px,${warPointer.y*-8}px,0) rotate(-1deg)`}}><img src="/images/archive-curated-v1/new/join-cosaques-1915.jpg" alt="Группа казаков, 1915 год"/><figcaption><b>СЛУЖБА</b><span>Снимок становился памятью для семьи.</span></figcaption></figure>
        <figure className="war-photo w4" style={{transform:`translate3d(${warPointer.x*-11}px,${warPointer.y*9}px,0) rotate(3deg)`}}><img src="/images/archive-wall/archive-05.jpg" alt="Казаки у собора перед отправлением"/><figcaption><b>ДОРОГА</b><span>Из станицы уходили вместе.</span></figcaption></figure>
      </div>
