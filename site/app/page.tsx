  ...
  return <main>
    ...
    <section className="scene living-culture">
      ...
      <div className="artist-stack">
        ...
        <article className="artist-card artist-beloboka" style={{ transform:`translateY(${Math.max(-55,Math.min(55,(scroll-5650)*.026))}px)` }}><img src="/images/beloboka-don.png" alt="BELOBOKA — современный электронный фолк-проект"/><div><span>02 / НОВЫЙ ФОЛК</span><h3>BELOBOKA</h3><p>Фольклор, индустриальный звук и новая сцена.</p></div></article>
        <article className="artist-card artist-yazhevika" style={{ transform:`translateY(${Math.max(-75,Math.min(75,(scroll-5850)*-.03))}px)` }}><img src="/images/yazhevika-don.png" alt="YAZHEVIKA — донская казачка и современная исполнительница"/><div><span>03 / ГОЛОС</span><h3>YAZHEVIKA</h3><p>Сталь, крест и женская сила Дона.</p></div></article>
      </div>
